...
public class TwoHeaderPinnedActivity extends AppCompatActivity {
    ...
    public static void GoToTwoHeaderActivity(Context context){
        Intent intent = new Intent(context, TwoHeaderPinnedActivity.class);
    ...
    static class SimpleAdapter extends Adapter implements AdapterStick{
        ...
        public SimpleAdapter(Context context,List <SimpleBean>list){
            mContext = context;
            mList = list;
            ViewGroup content = (ViewGroup) ((TwoHeaderPinnedActivity) mContext).findViewById(android.R.id.content);
